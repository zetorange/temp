...
import cateyes
from cateyes_tools.application import Reactor
from cateyes_tools.tracer import Tracer, TracerProfileBuilder, MemoryRepository, UI
...
class TestTracer(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.session = cateyes.attach(cls.target.pid)
