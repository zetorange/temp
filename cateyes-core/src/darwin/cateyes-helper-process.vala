namespace Cateyes {
	public class DarwinHelperProcess : Object, DarwinHelper {
		...
		private static string make_service_name () {
			var builder = new StringBuilder ("re.cateyes.Helper");
	...
	private class ResourceStore {
		...
		public ResourceStore (TemporaryDirectory tempdir) throws Error {
			...
			var blob = Cateyes.Data.Helper.get_cateyes_helper_blob ();
			helper = new TemporaryFile.from_stream ("cateyes-helper",
