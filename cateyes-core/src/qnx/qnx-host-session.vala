namespace Cateyes {
	...
	public class QnxHostSession : BaseDBusHostSession {
		...
		construct {
			...
			var blob = Cateyes.Data.Agent.get_cateyes_agent_so_blob ();
		...
		public override async Cateyes.HostProcessInfo[] enumerate_processes () throws Error {
		...
		protected override async Gee.Promise<IOStream> perform_attach_to (uint pid, out Object? transport) throws Error {
			...
			var id = yield qinjector.inject_library_resource (pid, agent_desc, "cateyes_agent_main", t.remote_address);
