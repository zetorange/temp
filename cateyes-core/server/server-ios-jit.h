#ifndef	_cateyes_jit_server_
#define	_cateyes_jit_server_
...
extern
#endif	/* mig_external */
mig_routine_t cateyes_jit_server_routine(
		mach_msg_header_t *InHeadP);


/* Description of this subsystem, for use in direct RPC */
extern const struct cateyes_jit_subsystem {
