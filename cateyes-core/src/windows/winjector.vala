	...
	public class Winjector : Object, Injector {
		...
		private class HelperFactory {
			...
			public async HelperInstance obtain () throws Error {
				...
				if (obtain_requests.is_empty) {
					...
					new Thread<bool> ("cateyes-winjector", obtain_worker);
				}
		...
		public class ResourceStore {
			...
			public ResourceStore () throws Error {
				...
				var blob32 = Cateyes.Data.Winjector.get_winjector_helper_32_exe_blob ();
				helper32 = new TemporaryFile.from_stream ("cateyes-winjector-helper-32.exe",
					new MemoryInputStream.from_data (blob32.data, null),
					tempdir);

				var blob64 = Cateyes.Data.Winjector.get_winjector_helper_64_exe_blob ();
				helper64 = new TemporaryFile.from_stream ("cateyes-winjector-helper-64.exe",
