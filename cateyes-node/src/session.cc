...
Session::Session(CateyesSession* handle, Runtime* runtime)
...
NAN_METHOD(Session::New) {
  ...
  auto handle = static_cast<CateyesSession*>(
...
NAN_PROPERTY_GETTER(Session::GetPid) {
  auto handle = ObjectWrap::Unwrap<Session>(
      info.Holder())->GetHandle<CateyesSession>();

  info.GetReturnValue().Set(Nan::New<v8::Uint32>(
      cateyes_session_get_pid(handle)));
}

class DetachOperation : public Operation<CateyesSession> {
 public:
  void Begin() {
    cateyes_session_detach(handle_, OnReady, this);
  }

  void End(GAsyncResult* result, GError** error) {
    cateyes_session_detach_finish(handle_, result);
  }
...
class CreateScriptOperation : public Operation<CateyesSession> {
 public:
  ...
  void Begin() {
    cateyes_session_create_script(handle_, name_, source_, OnReady, this);
  }

  void End(GAsyncResult* result, GError** error) {
    script_ = cateyes_session_create_script_finish(handle_, result, error);
  }
  ...
  gchar* name_;
  gchar* source_;
  CateyesScript* script_;
};

class EnableChildGatingOperation : public Operation<CateyesSession> {
 public:
  void Begin() {
    cateyes_session_enable_child_gating(handle_, OnReady, this);
  }

  void End(GAsyncResult* result, GError** error) {
    cateyes_session_enable_child_gating_finish(handle_, result, error);
  }
...
class DisableChildGatingOperation : public Operation<CateyesSession> {
 public:
  void Begin() {
    cateyes_session_disable_child_gating(handle_, OnReady, this);
  }

  void End(GAsyncResult* result, GError** error) {
    cateyes_session_disable_child_gating_finish(handle_, result, error);
  }
...
class CreateScriptFromBytesOperation : public Operation<CateyesSession> {
 public:
  ...
  void Begin() {
    cateyes_session_create_script_from_bytes(handle_, bytes_, OnReady, this);
  }

  void End(GAsyncResult* result, GError** error) {
    script_ = cateyes_session_create_script_from_bytes_finish(handle_, result,
        error);
  }
...
class CompileScriptOperation : public Operation<CateyesSession> {
 public:
  ...
  void Begin() {
    cateyes_session_compile_script(handle_, name_, source_, OnReady, this);
  }

  void End(GAsyncResult* result, GError** error) {
    bytes_ = cateyes_session_compile_script_finish(handle_, result, error);
  }
...
class EnableDebuggerOperation : public Operation<CateyesSession> {
 public:
  EnableDebuggerOperation(guint16 port) : port_(port) {
  }

  void Begin() {
    cateyes_session_enable_debugger(handle_, port_, OnReady, this);
  }

  void End(GAsyncResult* result, GError** error) {
    cateyes_session_enable_debugger_finish(handle_, result, error);
  }
...
class DisableDebuggerOperation : public Operation<CateyesSession> {
 public:
  void Begin() {
    cateyes_session_disable_debugger(handle_, OnReady, this);
  }

  void End(GAsyncResult* result, GError** error) {
    cateyes_session_disable_debugger_finish(handle_, result, error);
  }
...
class EnableJitOperation : public Operation<CateyesSession> {
 public:
  void Begin() {
    cateyes_session_enable_jit(handle_, OnReady, this);
  }

  void End(GAsyncResult* result, GError** error) {
    cateyes_session_enable_jit_finish(handle_, result, error);
  }
