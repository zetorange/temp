...
static const GumV8Property gumjs_cateyes_values[] =
{
...
static const GumV8Function gumjs_cateyes_functions[] =
{
  { "_loadObjC", gumjs_cateyes_objc_load },
  { "_loadJava", gumjs_cateyes_java_load },
                   ...
                   Handle<ObjectTemplate> scope)
{
  ...
  auto cateyes = _gum_v8_create_module ("Cateyes", scope, isolate);
  _gum_v8_module_add (module, cateyes, gumjs_cateyes_values, isolate);
  _gum_v8_module_add (module, cateyes, gumjs_cateyes_functions, isolate);
  cateyes->Set (_gum_v8_string_new_ascii (isolate, "version"),
      _gum_v8_string_new_ascii (isolate, CATEYES_VERSION), ReadOnly);
