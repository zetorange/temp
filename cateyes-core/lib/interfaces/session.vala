namespace Cateyes {
	[DBus (name = "re.cateyes.HostSession12")]
	...
	[DBus (name = "re.cateyes.AgentSessionProvider12")]
	...
	[DBus (name = "re.cateyes.AgentSession12")]
	...
	[DBus (name = "re.cateyes.AgentController12")]
	...
	namespace Marshal {
		public static Cateyes.Error from_dbus (GLib.Error e) {
			DBusError.strip_remote_error (e);
			if (e is Cateyes.Error) {
				return (Cateyes.Error) e;
			} else if (e is DBusError.UNKNOWN_METHOD) {
				return new Cateyes.Error.PROTOCOL ("Unable to communicate with remote cateyes-server; " +
					"please ensure that major versions match and that the remote Cateyes has the feature you are trying to use");
			} else {
				return new Cateyes.Error.TRANSPORT (e.message);
			}
		}
	...
	namespace ObjectPath {
		public const string HOST_SESSION = "/re/cateyes/HostSession";
		public const string AGENT_SESSION_PROVIDER = "/re/cateyes/AgentSessionProvider";
		public const string AGENT_SESSION = "/re/cateyes/AgentSession";
		public const string AGENT_CONTROLLER = "/re/cateyes/AgentController";
		public const string CHILD_SESSION = "/re/cateyes/ChildSession";
