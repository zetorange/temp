...
typedef struct _CateyesFruityModel CateyesFruityModel;

struct _CateyesFruityModel
{
  gint product_id;
  const gchar * name;
  const gchar * icon;
...
static const CateyesFruityModel fruity_models[] =
{
...
{
  const CateyesFruityModel * model;
  guint i;
  gchar * filename;
