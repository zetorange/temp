		...
		public async HostSession create (string? location = null) throws Error {
			...
			try {
				...
				if (e is IOError.CONNECTION_REFUSED)
					throw new Error.SERVER_NOT_RUNNING ("Unable to connect to remote cateyes-server");
				else
					throw new Error.SERVER_NOT_RUNNING ("Unable to connect to remote cateyes-server: " + e.message);
			}
			...
			try {
				...
				throw new Error.PROTOCOL ("Incompatible cateyes-server version");
			}
