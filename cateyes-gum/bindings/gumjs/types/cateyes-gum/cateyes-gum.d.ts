...
/**
 * Requests callback to be called on the next message received from your Cateyes-based application.
 *
...
/**
 * Sends a JSON-serializable message to your Cateyes-based application.
 */
declare function send(message: any): void;

/**
 * Sends a JSON-serializable message to your Cateyes-based application, along with some raw binary data.
...
/**
 * Calls `func` when Cateyes's event loop is idle.
...
/**
 * Schedules `func` to be called on Cateyes's JavaScript thread, optionally passing it the provided params.
...
declare namespace Cateyes {
    /**
     * The current Cateyes version.
     */
    const version: string;

    /**
     * The current size – in bytes – of Cateyes’s private heap, which is shared by all scripts and Cateyes’s own runtime.
...
declare namespace Process {
    ...
    /**
     * Whether Cateyes will avoid modifying existing code in memory and will not try to run unsigned code.
     ...
     *
     * You should return true if you did handle the exception, in which case Cateyes will resume the thread immediately.
     * If you do not return true, Cateyes will forward the exception to the hosting process’ exception handler, if it has
...
declare namespace Memory {
    ...
    /**
     * Allocates `size` bytes of memory on Cateyes's private heap, or, if `size` is a multiple of Process#pageSize,
    ...
    /**
     * Allocates, encodes and writes out `str` as a UTF-8 string on Cateyes's private heap.
    ...
    /**
     * Allocates, encodes and writes out `str` as a UTF-16 string on Cateyes's private heap.
     * See Memory#alloc() for details about its lifetime.
     *
     * @param str String to allocate.
     */
    ...
    /**
     * Allocates, encodes and writes out `str` as an ANSI string on Cateyes's private heap.
     * See Memory#alloc() for details about its lifetime.
     *
     * @param str String to allocate.
     */
