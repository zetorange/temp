...
CateyesImageData *
_cateyes_image_data_from_file (const gchar * filename, guint target_width, guint target_height)
{
#ifdef HAVE_MACOS
  ...
  if (image != nil)
  {
    ...
    _cateyes_image_data_init_from_native_image_scaled_to (result, image, target_width, target_height);
    [image release];
  }
...
void
_cateyes_image_data_init_from_native_image_scaled_to (CateyesImageData * data, CateyesNativeImage native_image, guint target_width, guint target_height)
{
#ifdef HAVE_MACOS
   ...
   * those usually rendered onto by the cateyes GUI... ICK!
   */
