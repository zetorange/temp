...
from cateyes import FileMonitor

from cateyes_tools.model import Module, Function, ModuleFunction, ObjCMethod


def main():
    from colorama import Fore, Style

    from cateyes_tools.application import ConsoleApplication, input_with_timeout
...
class Repository(object):
    ...
    def _create_stub_handler(self, function):
        ...
        return """\
/*
 * Auto-generated by Cateyes. Please modify to match the signature of %(display_name)s.
 * This stub is currently auto-generated from manpages when available.
 *
 * For full API reference, see: http://www.cateyes.re/docs/javascript-api/
 */
