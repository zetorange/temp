...
GUMJS_DECLARE_CONSTRUCTOR (gumjs_cateyes_construct)
GUMJS_DECLARE_GETTER (gumjs_cateyes_get_heap_size)
GUMJS_DECLARE_GETTER (gumjs_cateyes_get_source_map)
GUMJS_DECLARE_GETTER (gumjs_cateyes_objc_get_source_map)
GUMJS_DECLARE_GETTER (gumjs_cateyes_java_get_source_map)
GUMJS_DECLARE_FUNCTION (gumjs_cateyes_objc_load)
GUMJS_DECLARE_FUNCTION (gumjs_cateyes_java_load)
...
static const GumDukPropertyEntry gumjs_cateyes_values[] =
{
  { "heapSize", gumjs_cateyes_get_heap_size, NULL },
  { "sourceMap", gumjs_cateyes_get_source_map, NULL },
  { "_objcSourceMap", gumjs_cateyes_objc_get_source_map, NULL },
  { "_javaSourceMap", gumjs_cateyes_java_get_source_map, NULL },

  { NULL, NULL, NULL }
};

static const duk_function_list_entry gumjs_cateyes_functions[] =
{
  { "_loadObjC", gumjs_cateyes_objc_load, 0 },
  { "_loadJava", gumjs_cateyes_java_load, 0 },
                    ...
                    duk_context * ctx)
{
  ...
  duk_push_c_function (ctx, gumjs_cateyes_construct, 0);
  duk_push_object (ctx);
  duk_put_function_list (ctx, -1, gumjs_cateyes_functions);
  duk_put_prop_string (ctx, -2, "prototype");
  duk_new (ctx, 0);
  duk_put_global_string (ctx, "Cateyes");
...
GUMJS_DEFINE_GETTER (gumjs_get_promise)
{
  ...
  duk_get_prop_string (ctx, -1, "Cateyes");
...
GUMJS_DEFINE_CONSTRUCTOR (gumjs_cateyes_construct)
{
  (void) args;

  duk_push_this (ctx);

  duk_push_string (ctx, CATEYES_VERSION);
  duk_put_prop_string (ctx, -2, "version");

  _gum_duk_add_properties_to_class_by_heapptr (ctx,
      duk_require_heapptr (ctx, -1), gumjs_cateyes_values);
...
GUMJS_DEFINE_GETTER (gumjs_cateyes_get_heap_size)
{
  duk_push_uint (ctx, gum_peek_private_memory_usage ());
  return 1;
}

GUMJS_DEFINE_GETTER (gumjs_cateyes_get_source_map)
{
...
GUMJS_DEFINE_GETTER (gumjs_cateyes_objc_get_source_map)
{
...
GUMJS_DEFINE_GETTER (gumjs_cateyes_java_get_source_map)
{
  duk_push_heapptr (ctx, args->core->source_map);
...
GUMJS_DEFINE_FUNCTION (gumjs_cateyes_objc_load)
{
  (void) args;
...
GUMJS_DEFINE_FUNCTION (gumjs_cateyes_java_load)
{
  (void) args;
