 ...
 * _CATEYES_ENABLE_PYDEBUG.
 */
#if defined (_DEBUG) && !defined (_CATEYES_ENABLE_PYDEBUG)
# undef _DEBUG
# include <pyconfig.h>
# define _DEBUG
#else
...
# define PYCATEYES_GETARGSPEC_FUNCTION "getfullargspec"
#else
...
# define PYCATEYES_GETARGSPEC_FUNCTION "getargspec"
#endif

#define PYCATEYES_TYPE(name) \
  G_PASTE (G_PASTE (Py, name), Type)
#define PYCATEYES_TYPE_SPEC(name) \
  G_PASTE (PYCATEYES_TYPE (name), _type_spec)
#define PYCATEYES_DEFINE_TYPE(name, init_from_handle, destroy) \
  static const PyGObjectTypeSpec PYCATEYES_TYPE_SPEC (name) = { &PYCATEYES_TYPE (name), (PyGObjectInitFromHandleFunc) init_from_handle, destroy }
#define PYCATEYES_REGISTER_TYPE(name, gtype) \
  G_BEGIN_DECLS \
  { \
    PyTypeObject * pytype = &PYCATEYES_TYPE (name); \
    pytype->tp_new = PyType_GenericNew; \
    if (PyType_Ready (pytype) < 0) \
      return MOD_ERROR_VAL; \
    PyGObject_register_type (gtype, &PYCATEYES_TYPE_SPEC (name)); \
    Py_INCREF (pytype); \
...
#define CATEYES_FUNCPTR_TO_POINTER(f) (GSIZE_TO_POINTER (f))
...
static PyObject * PyDevice_new_take_handle (CateyesDevice * handle);
static int PyDevice_init (PyDevice * self, PyObject * args, PyObject * kw);
static void PyDevice_init_from_handle (PyDevice * self, CateyesDevice * handle);
...
static PyObject * PyApplication_new_take_handle (CateyesApplication * handle);
static int PyApplication_init (PyApplication * self, PyObject * args, PyObject * kw);
static void PyApplication_init_from_handle (PyApplication * self, CateyesApplication * handle);
...
static PyObject * PyProcess_new_take_handle (CateyesProcess * handle);
static int PyProcess_init (PyProcess * self, PyObject * args, PyObject * kw);
static void PyProcess_init_from_handle (PyProcess * self, CateyesProcess * handle);
...
static PyObject * PySpawn_new_take_handle (CateyesSpawn * handle);
static int PySpawn_init (PySpawn * self, PyObject * args, PyObject * kw);
static void PySpawn_init_from_handle (PySpawn * self, CateyesSpawn * handle);
static void PySpawn_dealloc (PySpawn * self);
static PyObject * PySpawn_repr (PySpawn * self);

static PyObject * PyChild_new_take_handle (CateyesChild * handle);
static int PyChild_init (PyChild * self, PyObject * args, PyObject * kw);
static void PyChild_init_from_handle (PyChild * self, CateyesChild * handle);
static void PyChild_dealloc (PyChild * self);
static PyObject * PyChild_repr (PyChild * self);

static PyObject * PyIcon_new_from_handle (CateyesIcon * handle);
static int PyIcon_init (PyIcon * self, PyObject * args, PyObject * kw);
static void PyIcon_init_from_handle (PyIcon * self, CateyesIcon * handle);
static void PyIcon_dealloc (PyIcon * self);
static PyObject * PyIcon_repr (PyIcon * self);

static PyObject * PySession_new_take_handle (CateyesSession * handle);
static int PySession_init (PySession * self, PyObject * args, PyObject * kw);
static void PySession_init_from_handle (PySession * self, CateyesSession * handle);
...
static PyObject * PyScript_new_take_handle (CateyesScript * handle);
...
static PyObject * PyCateyes_raise (GError * error);
static gboolean PyCateyes_is_string (PyObject * obj);
static gchar * PyCateyes_repr (PyObject * obj);
static guint PyCateyes_get_max_argument_count (PyObject * callable);
...
PYCATEYES_DEFINE_TYPE (GObject, NULL, g_object_unref);

static PyTypeObject PyDeviceManagerType =
{
  PyVarObject_HEAD_INIT (NULL, 0)
  "_cateyes.DeviceManager",                       /* tp_name           */
...
PYCATEYES_DEFINE_TYPE (DeviceManager, NULL, cateyes_unref);

static PyTypeObject PyDeviceType =
{
  PyVarObject_HEAD_INIT (NULL, 0)
  "_cateyes.Device",                              /* tp_name           */
...
PYCATEYES_DEFINE_TYPE (Device, PyDevice_init_from_handle, cateyes_unref);

static PyTypeObject PyApplicationType =
{
  PyVarObject_HEAD_INIT (NULL, 0)
  "_cateyes.Application",                         /* tp_name           */
...
PYCATEYES_DEFINE_TYPE (Application, PyApplication_init_from_handle, g_object_unref);

static PyTypeObject PyProcessType =
{
  PyVarObject_HEAD_INIT (NULL, 0)
  "_cateyes.Process",                             /* tp_name           */
...
PYCATEYES_DEFINE_TYPE (Process, PyProcess_init_from_handle, g_object_unref);

static PyTypeObject PySpawnType =
{
  PyVarObject_HEAD_INIT (NULL, 0)
  "_cateyes.Spawn",                               /* tp_name           */
...
PYCATEYES_DEFINE_TYPE (Spawn, PySpawn_init_from_handle, g_object_unref);

static PyTypeObject PyChildType =
{
  PyVarObject_HEAD_INIT (NULL, 0)
  "_cateyes.Child",                               /* tp_name           */
...
PYCATEYES_DEFINE_TYPE (Child, PyChild_init_from_handle, g_object_unref);

static PyTypeObject PyIconType =
{
  PyVarObject_HEAD_INIT (NULL, 0)
  "_cateyes.Icon",                                /* tp_name           */
...
PYCATEYES_DEFINE_TYPE (Icon, PyIcon_init_from_handle, g_object_unref);

static PyTypeObject PySessionType =
{
  PyVarObject_HEAD_INIT (NULL, 0)
  "_cateyes.Session",                             /* tp_name           */
...
PYCATEYES_DEFINE_TYPE (Session, PySession_init_from_handle, cateyes_unref);

static PyTypeObject PyScriptType =
{
  PyVarObject_HEAD_INIT (NULL, 0)
  "_cateyes.Script",                              /* tp_name           */
...
PYCATEYES_DEFINE_TYPE (Script, NULL, cateyes_unref);

static PyTypeObject PyFileMonitorType =
{
  PyVarObject_HEAD_INIT (NULL, 0)
  "_cateyes.FileMonitor",                         /* tp_name           */
...
PYCATEYES_DEFINE_TYPE (FileMonitor, NULL, cateyes_unref);
...
{
  self->handle = NULL;
  self->spec = &PYCATEYES_TYPE_SPEC (GObject);
...
PyGObject_on (PyGObject * self, PyObject * args)
{
  ...
  max_arg_count = PyCateyes_get_max_argument_count (callback);
...
{
  if (g_str_has_prefix (cname, "Cateyes"))
    return cname + 5;
...
PyGObject_marshal_object (gpointer handle, GType type)
{
  ...
  if (spec == NULL)
    spec = &PYCATEYES_TYPE_SPEC (GObject);
...
PyDeviceManager_init (PyDeviceManager * self, PyObject * args, PyObject * kw)
{
  ...
  PyGObject_take_handle (&self->parent, cateyes_device_manager_new (), &PYCATEYES_TYPE_SPEC (DeviceManager));
...
{
  Py_BEGIN_ALLOW_THREADS
  cateyes_device_manager_close_sync (PY_GOBJECT_HANDLE (self));
  Py_END_ALLOW_THREADS
...
{
  GError * error = NULL;
  CateyesDeviceList * result;
  gint result_length, i;
  PyObject * devices;

  Py_BEGIN_ALLOW_THREADS
  result = cateyes_device_manager_enumerate_devices_sync (PY_GOBJECT_HANDLE (self), &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);

  result_length = cateyes_device_list_size (result);
  devices = PyList_New (result_length);
  for (i = 0; i != result_length; i++)
  {
    PyList_SET_ITEM (devices, i, PyDevice_new_take_handle (cateyes_device_list_get (result, i)));
  }
  cateyes_unref (result);
...
PyDeviceManager_add_remote_device (PyDeviceManager * self, PyObject * args)
{
  const char * host;
  GError * error = NULL;
  CateyesDevice * result;

  if (!PyArg_ParseTuple (args, "s", &host))
    return NULL;

  Py_BEGIN_ALLOW_THREADS
  result = cateyes_device_manager_add_remote_device_sync (PY_GOBJECT_HANDLE (self), host, &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
PyDeviceManager_remove_remote_device (PyDeviceManager * self, PyObject * args)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  cateyes_device_manager_remove_remote_device_sync (PY_GOBJECT_HANDLE (self), host, &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
static PyObject *
PyDevice_new_take_handle (CateyesDevice * handle)
{
  return PyGObject_new_take_handle (handle, &PYCATEYES_TYPE_SPEC (Device));
}
...
static void
PyDevice_init_from_handle (PyDevice * self, CateyesDevice * handle)
{
  self->id = PyUnicode_FromUTF8String (cateyes_device_get_id (handle));
  self->name = PyUnicode_FromUTF8String (cateyes_device_get_name (handle));
  self->icon = PyIcon_new_from_handle (cateyes_device_get_icon (handle));
  self->type = PyGObject_marshal_enum (cateyes_device_get_dtype (handle), CATEYES_TYPE_DEVICE_TYPE);
}
...
{
  GError * error = NULL;
  CateyesApplication * result;

  Py_BEGIN_ALLOW_THREADS
  result = cateyes_device_get_frontmost_application_sync (PY_GOBJECT_HANDLE (self), &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
{
  GError * error = NULL;
  CateyesApplicationList * result;
  gint result_length, i;
  PyObject * applications;

  Py_BEGIN_ALLOW_THREADS
  result = cateyes_device_enumerate_applications_sync (PY_GOBJECT_HANDLE (self), &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);

  result_length = cateyes_application_list_size (result);
  applications = PyList_New (result_length);
  for (i = 0; i != result_length; i++)
  {
    PyList_SET_ITEM (applications, i, PyApplication_new_take_handle (cateyes_application_list_get (result, i)));
  }
...
{
  GError * error = NULL;
  CateyesProcessList * result;
  gint result_length, i;
  PyObject * processes;

  Py_BEGIN_ALLOW_THREADS
  result = cateyes_device_enumerate_processes_sync (PY_GOBJECT_HANDLE (self), &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);

  result_length = cateyes_process_list_size (result);
  processes = PyList_New (result_length);
  for (i = 0; i != result_length; i++)
  {
    PyList_SET_ITEM (processes, i, PyProcess_new_take_handle (cateyes_process_list_get (result, i)));
  }
  g_object_unref (result);
...
PyDevice_enable_spawn_gating (PyDevice * self)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  cateyes_device_enable_spawn_gating_sync (PY_GOBJECT_HANDLE (self), &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
PyDevice_disable_spawn_gating (PyDevice * self)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  cateyes_device_disable_spawn_gating_sync (PY_GOBJECT_HANDLE (self), &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
{
  GError * error = NULL;
  CateyesSpawnList * result;
  gint result_length, i;
  PyObject * spawn;

  Py_BEGIN_ALLOW_THREADS
  result = cateyes_device_enumerate_pending_spawn_sync (PY_GOBJECT_HANDLE (self), &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);

  result_length = cateyes_spawn_list_size (result);
  spawn = PyList_New (result_length);
  for (i = 0; i != result_length; i++)
  {
    PyList_SET_ITEM (spawn, i, PySpawn_new_take_handle (cateyes_spawn_list_get (result, i)));
  }
  g_object_unref (result);
...
{
  GError * error = NULL;
  CateyesChildList * result;
  gint result_length, i;
  PyObject * children;

  Py_BEGIN_ALLOW_THREADS
  result = cateyes_device_enumerate_pending_children_sync (PY_GOBJECT_HANDLE (self), &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);

  result_length = cateyes_child_list_size (result);
  children = PyList_New (result_length);
  for (i = 0; i != result_length; i++)
  {
    PyList_SET_ITEM (children, i, PyChild_new_take_handle (cateyes_child_list_get (result, i)));
  }
  g_object_unref (result);
...
PyDevice_spawn (PyDevice * self, PyObject * args, PyObject * kw)
{
  ...
  options = cateyes_spawn_options_new ();
  ...
  if (argv_value != Py_None)
  {
    ...
    cateyes_spawn_options_set_argv (options, argv, argv_length);
  ...
  if (envp_value != Py_None)
  {
    ...
    cateyes_spawn_options_set_envp (options, envp, envp_length);
  ...
  if (env_value != Py_None)
  {
    ...
    cateyes_spawn_options_set_env (options, env, env_length);

    g_strfreev (env);
  }

  if (cwd != NULL)
    cateyes_spawn_options_set_cwd (options, cwd);

  if (stdio_value != NULL)
  {
    CateyesStdio stdio;

    if (!PyGObject_unmarshal_enum (stdio_value, CATEYES_TYPE_STDIO, &stdio))
      goto invalid_argument;

    cateyes_spawn_options_set_stdio (options, stdio);
  }
  ...
  if (aux_value != Py_None)
  {
    ...
    aux = cateyes_spawn_options_get_aux (options);
  ...
  Py_BEGIN_ALLOW_THREADS
  pid = cateyes_device_spawn_sync (PY_GOBJECT_HANDLE (self), program, options, &error);
  Py_END_ALLOW_THREADS
...
PyDevice_input (PyDevice * self, PyObject * args)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  cateyes_device_input_sync (PY_GOBJECT_HANDLE (self), (guint) pid, data, &error);
  Py_END_ALLOW_THREADS
...
PyDevice_resume (PyDevice * self, PyObject * args)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  cateyes_device_resume_sync (PY_GOBJECT_HANDLE (self), (guint) pid, &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
PyDevice_kill (PyDevice * self, PyObject * args)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  cateyes_device_kill_sync (PY_GOBJECT_HANDLE (self), (guint) pid, &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
PyDevice_attach (PyDevice * self, PyObject * args)
{
  long pid;
  GError * error = NULL;
  CateyesSession * handle;

  if (!PyArg_ParseTuple (args, "l", &pid))
    return NULL;

  Py_BEGIN_ALLOW_THREADS
  handle = cateyes_device_attach_sync (PY_GOBJECT_HANDLE (self), (guint) pid, &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
PyDevice_inject_library_file (PyDevice * self, PyObject * args)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  id = cateyes_device_inject_library_file_sync (PY_GOBJECT_HANDLE (self), (guint) pid, path, entrypoint, data, &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
PyDevice_inject_library_blob (PyDevice * self, PyObject * args)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  id = cateyes_device_inject_library_blob_sync (PY_GOBJECT_HANDLE (self), (guint) pid, blob, entrypoint, data, &error);
  Py_END_ALLOW_THREADS
...
static PyObject *
PyApplication_new_take_handle (CateyesApplication * handle)
{
  return PyGObject_new_take_handle (handle, &PYCATEYES_TYPE_SPEC (Application));
}
...
static void
PyApplication_init_from_handle (PyApplication * self, CateyesApplication * handle)
{
  self->identifier = PyUnicode_FromUTF8String (cateyes_application_get_identifier (handle));
  self->name = PyUnicode_FromUTF8String (cateyes_application_get_name (handle));
  self->pid = cateyes_application_get_pid (handle);
}
...
{
  return PyIcon_new_from_handle (cateyes_application_get_small_icon (PY_GOBJECT_HANDLE (self)));
}

static PyObject *
PyApplication_get_large_icon (PyApplication * self)
{
  return PyIcon_new_from_handle (cateyes_application_get_large_icon (PY_GOBJECT_HANDLE (self)));
}


static PyObject *
PyProcess_new_take_handle (CateyesProcess * handle)
{
  return PyGObject_new_take_handle (handle, &PYCATEYES_TYPE_SPEC (Process));
}
...
static void
PyProcess_init_from_handle (PyProcess * self, CateyesProcess * handle)
{
  self->pid = cateyes_process_get_pid (handle);
  self->name = PyUnicode_FromUTF8String (cateyes_process_get_name (handle));
}
...
{
  return PyIcon_new_from_handle (cateyes_process_get_small_icon (PY_GOBJECT_HANDLE (self)));
}

static PyObject *
PyProcess_get_large_icon (PyProcess * self)
{
  return PyIcon_new_from_handle (cateyes_process_get_large_icon (PY_GOBJECT_HANDLE (self)));
}


static PyObject *
PySpawn_new_take_handle (CateyesSpawn * handle)
{
  return PyGObject_new_take_handle (handle, &PYCATEYES_TYPE_SPEC (Spawn));
}
...
static void
PySpawn_init_from_handle (PySpawn * self, CateyesSpawn * handle)
{
  self->pid = cateyes_spawn_get_pid (handle);
  self->identifier = PyGObject_marshal_string (cateyes_spawn_get_identifier (handle));
}
...
static PyObject *
PyChild_new_take_handle (CateyesChild * handle)
{
  return PyGObject_new_take_handle (handle, &PYCATEYES_TYPE_SPEC (Child));
}
...
static void
PyChild_init_from_handle (PyChild * self, CateyesChild * handle)
{
  gchar * const * argv, * const * envp;
  gint argv_length, envp_length;

  self->pid = cateyes_child_get_pid (handle);
  self->parent_pid = cateyes_child_get_parent_pid (handle);

  self->origin = PyGObject_marshal_enum (cateyes_child_get_origin (handle), CATEYES_TYPE_CHILD_ORIGIN);

  self->identifier = PyGObject_marshal_string (cateyes_child_get_identifier (handle));

  self->path = PyGObject_marshal_string (cateyes_child_get_path (handle));

  argv = cateyes_child_get_argv (handle, &argv_length);
  self->argv = PyGObject_marshal_strv (argv, argv_length);

  envp = cateyes_child_get_envp (handle, &envp_length);
...
PyChild_repr (PyChild * self)
{
  ...
  origin = cateyes_child_get_origin (handle);
  origin_class = g_type_class_ref (CATEYES_TYPE_CHILD_ORIGIN);
  ...
  if (self->identifier != Py_None)
  {
    ...
    identifier = PyCateyes_repr (self->identifier);
  ...
  if (origin != CATEYES_CHILD_ORIGIN_FORK)
  {
    gchar * path, * argv, * envp;

    path = PyCateyes_repr (self->path);
    argv = PyCateyes_repr (self->argv);
    envp = PyCateyes_repr (self->envp);
...
static PyObject *
PyIcon_new_from_handle (CateyesIcon * handle)
{
  if (handle != NULL)
    g_object_ref (handle);

  return PyGObject_new_take_handle (handle, &PYCATEYES_TYPE_SPEC (Icon));
}
...
static void
PyIcon_init_from_handle (PyIcon * self, CateyesIcon * handle)
{
  gconstpointer pixels;
  gsize pixels_size;

  self->width = cateyes_icon_get_width (handle);
  self->height = cateyes_icon_get_height (handle);
  self->rowstride = cateyes_icon_get_rowstride (handle);
  pixels = g_bytes_get_data (cateyes_icon_get_pixels (handle), &pixels_size);
...
static PyObject *
PySession_new_take_handle (CateyesSession * handle)
{
  return PyGObject_new_take_handle (handle, &PYCATEYES_TYPE_SPEC (Session));
}
...
static void
PySession_init_from_handle (PySession * self, CateyesSession * handle)
{
  self->pid = cateyes_session_get_pid (handle);
}
...
{
  Py_BEGIN_ALLOW_THREADS
  cateyes_session_detach_sync (PY_GOBJECT_HANDLE (self));
  Py_END_ALLOW_THREADS
...
PySession_enable_child_gating (PySession * self)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  cateyes_session_enable_child_gating_sync (PY_GOBJECT_HANDLE (self), &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
PySession_disable_child_gating (PySession * self)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  cateyes_session_disable_child_gating_sync (PY_GOBJECT_HANDLE (self), &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
PySession_create_script (PySession * self, PyObject * args, PyObject * kw)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  handle = cateyes_session_create_script_sync (PY_GOBJECT_HANDLE (self), name, source, &error);
  Py_END_ALLOW_THREADS
...
PySession_create_script_from_bytes (PySession * self, PyObject * args, PyObject * kw)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  handle = cateyes_session_create_script_from_bytes_sync (PY_GOBJECT_HANDLE (self), bytes, &error);
  Py_END_ALLOW_THREADS
...
PySession_compile_script (PySession * self, PyObject * args, PyObject * kw)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  bytes = cateyes_session_compile_script_sync (PY_GOBJECT_HANDLE (self), name, source, &error);
  Py_END_ALLOW_THREADS
...
PySession_enable_debugger (PySession * self, PyObject * args, PyObject * kw)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  cateyes_session_enable_debugger_sync (PY_GOBJECT_HANDLE (self), port, &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
PySession_disable_debugger (PySession * self)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  cateyes_session_disable_debugger_sync (PY_GOBJECT_HANDLE (self), &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
PySession_enable_jit (PySession * self)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  cateyes_session_enable_jit_sync (PY_GOBJECT_HANDLE (self), &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
static PyObject *
PyScript_new_take_handle (CateyesScript * handle)
{
  return PyGObject_new_take_handle (handle, &PYCATEYES_TYPE_SPEC (Script));
}
...
PyScript_load (PyScript * self)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  cateyes_script_load_sync (PY_GOBJECT_HANDLE (self), &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
PyScript_unload (PyScript * self)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  cateyes_script_unload_sync (PY_GOBJECT_HANDLE (self), &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
PyScript_post (PyScript * self, PyObject * args, PyObject * kw)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  cateyes_script_post_sync (PY_GOBJECT_HANDLE (self), message, data, &error);
  Py_END_ALLOW_THREADS
...
PyFileMonitor_init (PyFileMonitor * self, PyObject * args, PyObject * kw)
{
  ...
  PyGObject_take_handle (&self->parent, cateyes_file_monitor_new (path), &PYCATEYES_TYPE_SPEC (FileMonitor));
...
PyFileMonitor_enable (PyFileMonitor * self)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  cateyes_file_monitor_enable_sync (PY_GOBJECT_HANDLE (self), NULL, &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
PyFileMonitor_disable (PyFileMonitor * self)
{
  ...
  Py_BEGIN_ALLOW_THREADS
  cateyes_file_monitor_disable_sync (PY_GOBJECT_HANDLE (self), &error);
  Py_END_ALLOW_THREADS
  if (error != NULL)
    return PyCateyes_raise (error);
...
static void
PyCateyes_object_decref (gpointer obj)
{
  PyObject * o = obj;
  Py_DECREF (o);
}
...
static PyObject *
PyCateyes_raise (GError * error)
{
  PyObject * exception;
  GString * message;

  g_assert (error->domain == CATEYES_ERROR);
...
static gboolean
PyCateyes_is_string (PyObject * obj)
{
#if PY_MAJOR_VERSION >= 3
...
static guint
PyCateyes_get_max_argument_count (PyObject * callable)
{
...
MOD_INIT (_cateyes)
{
  ...
  inspect_getargspec = PyObject_GetAttrString (inspect, PYCATEYES_GETARGSPEC_FUNCTION);
  ...
  MOD_DEF (module, "_cateyes", "Cateyes", NULL);

  PyModule_AddStringConstant (module, "__version__", cateyes_version_string ());

  PYCATEYES_REGISTER_TYPE (GObject, G_TYPE_OBJECT);
  PYCATEYES_REGISTER_TYPE (DeviceManager, CATEYES_TYPE_DEVICE_MANAGER);
  PYCATEYES_REGISTER_TYPE (Device, CATEYES_TYPE_DEVICE);
  PYCATEYES_REGISTER_TYPE (Application, CATEYES_TYPE_APPLICATION);
  PYCATEYES_REGISTER_TYPE (Process, CATEYES_TYPE_PROCESS);
  PYCATEYES_REGISTER_TYPE (Spawn, CATEYES_TYPE_SPAWN);
  PYCATEYES_REGISTER_TYPE (Child, CATEYES_TYPE_CHILD);
  PYCATEYES_REGISTER_TYPE (Icon, CATEYES_TYPE_ICON);
  PYCATEYES_REGISTER_TYPE (Session, CATEYES_TYPE_SESSION);
  PYCATEYES_REGISTER_TYPE (Script, CATEYES_TYPE_SCRIPT);
  PYCATEYES_REGISTER_TYPE (FileMonitor, CATEYES_TYPE_FILE_MONITOR);

  exception_by_error_code = g_hash_table_new_full (NULL, NULL, NULL, PyCateyes_object_decref);
#define PYCATEYES_DECLARE_EXCEPTION(code, name) \
    do \
    { \
      PyObject * exception = PyErr_NewException ("cateyes." name "Error", NULL, NULL); \
      g_hash_table_insert (exception_by_error_code, GINT_TO_POINTER (G_PASTE (CATEYES_ERROR_, code)), exception); \
      Py_INCREF (exception); \
      PyModule_AddObject (module, name "Error", exception); \
    } while (FALSE)
  PYCATEYES_DECLARE_EXCEPTION (SERVER_NOT_RUNNING, "ServerNotRunning");
  PYCATEYES_DECLARE_EXCEPTION (EXECUTABLE_NOT_FOUND, "ExecutableNotFound");
  PYCATEYES_DECLARE_EXCEPTION (EXECUTABLE_NOT_SUPPORTED, "ExecutableNotSupported");
  PYCATEYES_DECLARE_EXCEPTION (PROCESS_NOT_FOUND, "ProcessNotFound");
  PYCATEYES_DECLARE_EXCEPTION (PROCESS_NOT_RESPONDING, "ProcessNotResponding");
  PYCATEYES_DECLARE_EXCEPTION (INVALID_ARGUMENT, "InvalidArgument");
  PYCATEYES_DECLARE_EXCEPTION (INVALID_OPERATION, "InvalidOperation");
  PYCATEYES_DECLARE_EXCEPTION (PERMISSION_DENIED, "PermissionDenied");
  PYCATEYES_DECLARE_EXCEPTION (ADDRESS_IN_USE, "AddressInUse");
  PYCATEYES_DECLARE_EXCEPTION (TIMED_OUT, "TimedOut");
  PYCATEYES_DECLARE_EXCEPTION (NOT_SUPPORTED, "NotSupported");
  PYCATEYES_DECLARE_EXCEPTION (PROTOCOL, "Protocol");
  PYCATEYES_DECLARE_EXCEPTION (TRANSPORT, "Transport");
