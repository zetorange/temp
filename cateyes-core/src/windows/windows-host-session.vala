namespace Cateyes {
	...
	public class WindowsHostSession : BaseDBusHostSession {
		...
		construct {
			...
			var blob32 = Cateyes.Data.Agent.get_cateyes_agent_32_dll_blob ();
			var blob64 = Cateyes.Data.Agent.get_cateyes_agent_64_dll_blob ();
			var dbghelp32 = Cateyes.Data.Agent.get_dbghelp_32_dll_blob ();
			var dbghelp64 = Cateyes.Data.Agent.get_dbghelp_64_dll_blob ();
			agent_desc = new AgentDescriptor.with_resources ("cateyes-agent-%u.dll",
		...
		protected override async Gee.Promise<IOStream> perform_attach_to (uint pid, out Object? transport) throws Error {
			...
			var winjector = injector as Winjector;
			var id = yield winjector.inject_library_resource (pid, agent_desc, "cateyes_agent_main", t.remote_address);
