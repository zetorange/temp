namespace Cateyes.Test {

	public static void run (string[] args) {
		Environment.init (ref args);

		Cateyes.SystemTest.add_tests ();

		Cateyes.InjectorTest.add_tests ();

		Cateyes.AgentTest.add_tests ();
#if !WINDOWS
		Cateyes.GadgetTest.add_tests ();
#endif
		Cateyes.HostSessionTest.add_tests ();
